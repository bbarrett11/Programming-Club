...
public class HelloWorld {
	public static void main(String[] args)
	{
		...
		System.out.println("Hello World");
		//hello?
		System.out.println("Veenon was here");
		System.out.println("SEE MY WORDS BEN");
		System.out.println(howToAddComments(1));
	}
	
	/**
	 * A method that returns an explanation on how to write java-Docs for methods
	 * @param uselessParameter a useless parameter that exists only to illustrate
